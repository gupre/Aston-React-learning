...
Учебный проект, выполненный в рамках подготовки к стажировке в Aston. Задача — изучить и применить на практике современный стек React-разработки: Redux Toolkit, React Router, TypeScript, архитектурные подходы. Приложение на базе JSONPlaceholder API — работа с публичными данными (посты, пользователи, альбомы, фото, комментарии, задачи).
